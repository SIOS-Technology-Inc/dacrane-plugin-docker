...
var DockerContainerResource = dacranepdk.Resource{
...
var DockerNetworkResource = dacranepdk.Resource{
	Create: func(parameter any, meta dacranepdk.PluginMeta) (any, error) {
		params := parameter.(map[string]any)
		name := params["name"].(string)
...
var DockerLocalImageResource = dacranepdk.Resource{
	Create: func(parameter any, meta dacranepdk.PluginMeta) (any, error) {
		params := parameter.(map[string]any)
...
var DockerRemoteImage = dacranepdk.Resource{
	Create: func(parameter any, meta dacranepdk.PluginMeta) (any, error) {
		params := parameter.(map[string]any)
		image := params["image"].(string)
		tag := params["tag"].(string)
...
func RequestHttp(req *http.Request, m dacranepdk.PluginMeta) (*http.Response, error) {
